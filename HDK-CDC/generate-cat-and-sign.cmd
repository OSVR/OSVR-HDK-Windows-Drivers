rem Run this batch file with the current directory set to the bin/x86 directory of a very new Windows Driver Kit.
rem On my system, that was C:\Program Files (x86)\Windows Kits\10\bin\x86
...
call "%WDK_DIR%\Tools\x86\chkinf\chkinf" %DRIVER%.inf
