# "Compiles" directories containing device metadata package contents
# (de-duplicated and with template operators/substitutions in place)
# into proper .devicemetadata-ms packages - see README.md for more details.
#
...
process_dir("BeltBox2")
process_dir("TrackingCamera")
process_dir("TrackingCameraNeedsUpgrade")
